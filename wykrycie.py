...
print("here4")   # Suppress Matplotlib warnings
...
def visualize_boxes_and_labels_on_image_array(
  ...
  return image, koordy
print("here2")
source="C:/Users/barto/Desktop/Baza testowa klasy" 
...
for f1 in files:
    ...
    sciezka = ("C:/Users/barto/Desktop/OUTPUT/detection_output{}.png".format(i)) # śćieżka do folderu gdzie są zapisywane wycięte nosy (ostatecznie można wyjebać tą część)
    if (box[0] > 0 and box[1] > 0 and  box[2] > 0 and box[3] > 0):
      ...
      plt.imshow(image_np)
      plt.text(0, 0, box2[4], bbox=dict(fill=False, edgecolor='red', linewidth=2))
      plt.savefig("C:/Users/barto/Desktop/OUTPUT/detection_output{}.png".format(i)) # śćieżka do folderu gdzie zapisywany jest wynik (ostatecznie ma śię wyśweitelac wiec tez do wyjebania)
